...
namespace pag {
std::vector<GlyphHandle> Glyph::BuildFromText(
  ...
  for (const auto& glyph : glyphs) {
    glyphList.emplace_back(std::shared_ptr<Glyph>(new Glyph(glyph, paint)));
  }
  return glyphList;
}

Glyph::Glyph(std::shared_ptr<SimpleGlyph> simpleGlyph, const TextPaint& textPaint)
