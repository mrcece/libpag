...
class SimpleGlyph {
 public:
  SimpleGlyph(tgfx::GlyphID glyphId, std::string name, tgfx::Font font, bool isVertical);
  ...
  std::shared_ptr<SimpleGlyph> makeVerticalGlyph() const;
